                ...
                if idx42 == 0:
                    if randunif4[idx40][idx41][idx42] < tolpmfs4[idx40][idx41][idx42]:
                        ...
                        if storeidx in store4[idx40]:
                            ...
                            # using modulo 2 to ensure half of the memory locations are reserved for each arm
                            if replaceidx%2 == memevidarms4[idx42][idx41]:
...
@numba.jit
def params_nsteps(vdisc9, memplay9, idxf9, narms9, store9, perms9, memsuc9, memarms9, memshare9, memstore9, pulls9, nag9, con9, randunif90, pay9, params9, tol9, nsteps9):
...
def confirm_bias_full(vdiscf, mem_snapf, mem_depthf, erpf, memf, memsharef, memstoref, networktypef, maxalphabetaf, pullsf, nagf, narmsf, tolf, payprobsf, nstepsf, tstepsf, rngs, n0):
    ...
    for idxf in range(0, tstepsf, nstepsf):
        ...
        paramsf, evidarmsf, memsucf, memarmsf, memplayf = params_nsteps(vdiscf, memplayf, idxf, narmsf, storef, permsf, memsucf, memarmsf, memsharef, memstoref, pullsf, nagf, connections, randunif0f, payf, paramsf, tolf, nstepsf)
